...
export const Plan = () => {
  return (
    <div className="fondoPlan flex flex-col h-screen">
      ...
      <div className="todo">
        <div className="derecha flex flex-col md:flex-row items-center justify-between p-4 text-center">
          ...
          <img src={img} alt="Emprendedores" className="mt-4 w-full md:w-1/2 h-96 rounded-lg" />
        </div>
        <div className="izquierda  flex flex-col md:flex-row items-center justify-between p-4 text-center">
          ...
          <img src={imgg} alt="Emprendedores" className="mt-4 w-full md:w-1/2 h-80 rounded-lg" />
          <div className="mb-4 md:mb-0">
        ...
        <div className="derecha  flex flex-col md:flex-row items-center justify-between p-4 text-center">
          ...
          <img src={imggg} alt="Emprendedores" className="mt-4 w-full md:w-1/2 h-96 rounded-lg" />
        </div>
        {/* <div className="izquierda mb-10 flex flex-col md:flex-row items-center justify-between p-4">
           <img src={img} alt="Emprendedores" className="mt-4 w-full md:w-1/2 h-80 rounded-lg" />
          <div className="mb-4 md:mb-0">
            <div className="cuadrado w-20 h-20 bg-gray-300"></div>
            <h2 className="mt-4 text-5xl text-center"><span>Emprendedores</span></h2>
            <p className="text-center">loremskmdksmdksmdsmdksmdksdksdssjajdkjdsjd</p>
            <button className='h-14 text-2xl text-white w-80 rounded-full button'>ELEVA TU PRESENCIA</button>
          </div>
        </div> */}
      </div>
